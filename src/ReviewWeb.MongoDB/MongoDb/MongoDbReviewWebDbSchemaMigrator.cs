...
{
    public class MongoDbReviewWebDbSchemaMigrator : IReviewWebDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbReviewWebDbSchemaMigrator(IServiceProvider serviceProvider)
        {
